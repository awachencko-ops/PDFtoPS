...
- [x] Разделить UI и доменную логику (WinForms слой / сервисы / модели; выделены `GhostscriptRunner`, `PdfInputValidator`, модели результата).
- [x] Вынести профили и параметры в JSON-конфиг (`appsettings.json`).
- [x] Покрыть критическую логику unit/integration тестами (добавлен проект `PDFtoPS.Tests`).
