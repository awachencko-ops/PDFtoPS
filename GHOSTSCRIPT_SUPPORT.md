...
- Все ошибки и диагностическая информация пишутся в лог-файлы `yyyyMMdd.log` (по умолчанию `%LocalAppData%\PDFtoPS\logs`, с fallback в директорию приложения/Temp).
